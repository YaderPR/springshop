...
class ApparelCategoryApiRepository implements ApparelCategoryRepository {
  final Dio _dioClient;
  static const String _categoriesPath = '/products/apparels/categories';
  ApparelCategoryApiRepository(this._dioClient);
  @override
    ...
    try {
      ...
      if (response.statusCode == 200 && response.data != null) {
        ...
        return jsonList.map((json) {
          ...
          final List<int> productIdsList = (json['apparelIds'] as List<dynamic>?)
