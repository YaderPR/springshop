...
public class ApparelMapper {
    public static ApparelResponse toResponseDTO(Apparel apparel) {
        if (apparel == null)
            return null;

        ApparelResponse dto = new ApparelResponse();
    ...
    public static Apparel toEntity(ApparelRequest dto, Category category, ApparelCategory apparelCategory) {
        if (dto == null)
            return null;
    ...
    public static void updateApparel(Apparel existing, ApparelRequest dto, Category category,
