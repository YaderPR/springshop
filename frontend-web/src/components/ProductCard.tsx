...
<div
    ...
    bg-white/20 backdrop-blur-sm 
      ...
      hover:filter hover:shadow-[0_0_25px_rgba(137,254,0,1)]
      "
      >
      <div className="aspect-square bg-white/90 rounded-xl overflow-hidden ">
        <img src={imageUrl} alt={name} className="w-full h-full object-cover transform hover:scale-105 transition-transform duration-300" />
      </div>
