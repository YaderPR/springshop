...
import { useCart } from '../../../hooks/useCart'; // O el path correcto a tu contexto
...
export const Cart: React.FC<CartProps> = ({ cartId }) => {
  ...
  // --- CORRECCIÓN: Ordenar items por ID ---
  // Esto asegura que si actualizas la cantidad, el ítem no salte al final de la lista.
      ...
      {cartItems.length === 0 ? (
        ...
        <>
          <div className="space-y-4">
            {/* Usamos sortedCartItems en lugar de cartItems */}
